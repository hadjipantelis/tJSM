...
NewTimings <- microbenchmark( jmodelTM(fitLME, fitCOX, aids, model = 2, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, aids, model = 1, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, aids, model = 2, rho=0,timeVarY = 'obstime'),  jmodelTM(fitLME, fitCOX, aids, model = 1, rho=0,timeVarY = 'obstime'), times=64 )
...
OldTimings <- microbenchmark( jmodelTM(fitLME, fitCOX, aids, model = 2, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, aids, model = 1, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, aids, model = 2, rho=0,timeVarY = 'obstime'),  jmodelTM(fitLME, fitCOX, aids, model = 1, rho=0,timeVarY = 'obstime') , times=64)

save.image('First_modelwide_benchmarks.RData.Pantelis')


if (1==2){ # This is for future
load("liver.rda")
