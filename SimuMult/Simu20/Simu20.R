...
time1 <- system.time(fit1 <- jmodelMult(fitLME, fitCOX, Data, model = 2, control = control1))[3]
time2 <- system.time(fit2 <- jmodelMult(fitLME, fitCOX, Data, model = 2, control = control2))[3]
time3 <- system.time(fit3 <- jmodelMult(fitLME, fitCOX, Data, model = 2, control = control3))[3]
...
save(results, file = paste("MultResult20", i, ".RData", sep = ""))
