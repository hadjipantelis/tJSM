...
#=============== Simulation Study for Model I with rho = 0 ===============#
...
time1 <- system.time(fit1 <- jmodelTM(fitLME, fitCOX, Data, timeVarY = timeVarY, funcY = funcY, control = control1))[3]
time2 <- system.time(fit2 <- jmodelTM(fitLME, fitCOX, Data, timeVarY = timeVarY, funcY = funcY, control = control2))[3]
time3 <- system.time(fit3 <- jmodelTM(fitLME, fitCOX, Data, timeVarY = timeVarY, funcY = funcY, control = control3))[3]
...
save(results, file = paste("TMResult10", i, ".RData", sep = ""))
