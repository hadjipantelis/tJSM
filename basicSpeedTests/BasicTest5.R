...
NewTimings_Liver <- microbenchmark( jmodelTM(fitLME, fitCOX, liver, model = 2, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, liver, model = 1, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, liver, model = 2, rho=0,timeVarY = 'obstime'),  jmodelTM(fitLME, fitCOX, liver, model = 1, rho=0,timeVarY = 'obstime'), times=30 )
