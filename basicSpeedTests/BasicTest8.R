...
#NewTimings_Liver <- microbenchmark( jmodelTM(fitLME, fitCOX, liver, model = 2, rho=1,timeVarY = 'obstime'),  jmodelTM(fitLME, fitCOX, liver, model = 2, rho=0,timeVarY = 'obstime'), times=33 )
...
OldTimings_Liver_Long <- microbenchmark( jmodelTM(fitLME, fitCOX, liver, model = 1, rho=1,timeVarY = 'obstime'), jmodelTM(fitLME, fitCOX, liver, model = 2, rho=0,timeVarY = 'obstime') , times=66 )
}
save.image('Eighth_modelwide_benchmarks.RData.Pantelis')
